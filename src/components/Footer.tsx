...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#f5ede0] border-t border-[#e0d4c4]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-[#6a5a4e] text-sm leading-relaxed mb-4">
              Premium kids accessories crafted with love. Making every little moment special with our curated collection.
            </p>
            <div className="flex items-center gap-3">
              <a
                ...
                className="p-2 bg-white rounded-full text-[#1877F2] hover:bg-[#1877F2] hover:text-white transition-all shadow-sm"
                aria-label="Facebook"
              >
                <FacebookIcon />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-white rounded-full text-[#E4405F] hover:bg-[#E4405F] hover:text-white transition-all shadow-sm"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-white rounded-full text-[#000000] hover:bg-[#000000] hover:text-white transition-all shadow-sm"
                aria-label="TikTok"
              >
                <TikTokIcon />
              </a>
              {pinterestUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-white rounded-full text-[#E60023] hover:bg-[#E60023] hover:text-white transition-all shadow-sm"
              ...
              {whatsapp && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-white rounded-full text-[#25D366] hover:bg-[#25D366] hover:text-white transition-all shadow-sm"
                  aria-label="WhatsApp"
                >
                  <WhatsAppIcon />
                </a>
      ...
      <div className="border-t border-[#e0d4c4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <p className="text-center text-sm text-[#8a7a6e]">
            &copy; {currentYear} Tiny Treasure World. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
